...
class Database:
    ...
    def new_user(self, id):
        return dict(
            ...
            thumbnail=None,
            ffmpegcode=None,
            metadata=""" -map 0 -c:s copy -c:a copy -c:v copy -metadata title="Powered By:- @Kdraamaland" -metadata author="@Learnmore_official" -metadata:s:s title="Subtitled By :- @Kdraamaland" -metadata:s:a title="By :- @Kdraamaland" -metadata:s:v title="By:- @Learnmore_official" """,
            ban_status=dict(
                is_banned=False,
                ban_duration=0,
